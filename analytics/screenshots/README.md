...
- `pipeline-health-overview.png`
- `supplier-product-data-quality.png`
- `error-review-queue.png`

Each screenshot should show public-safe sample data only.

## Capture Notes

- Capture screenshots from the actual Power BI report, not from mockups.
- Keep page titles aligned to `analytics/dashboard_wireframe.md`.
